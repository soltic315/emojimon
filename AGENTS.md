...
4. コードの変更があった場合、セマンティックバージョニングの原則に従い、変更の種類に応じて適切なバージョン番号を更新する。
5. コードの変更があった場合、AIとのチャット完了後に `CHANGELOG.md` を更新する。
...
- 1ファイルが肥大化しないよう、責務ごとに適切にモジュール分割する（目安: 1ファイル1責務）。
